...
class Server_Api_Issues_List
{
    ...
    public function run( $typeId, $viewId, $projectId, $folderId, $searchColumn, $searchValue, $sortColumn, $sortAscending, $offset, $limit, $html, $allColumns )
    {
        if ( $typeId == null && $viewId == null && $folderId == null )
            throw new Server_Error( Server_Error::InvalidArguments .'1');
        if ( $viewId != null && $typeId != null )
            throw new Server_Error( Server_Error::InvalidArguments .'2'.$typeId);
        if ( $folderId != null && ( $typeId != null || $projectId != null ) )
            throw new Server_Error( Server_Error::InvalidArguments .'3'.( $typeId != null || $projectId != null ));
        if ( $offset < 0 || $limit < 1 )
            throw new Server_Error( Server_Error::InvalidArguments .'4');
